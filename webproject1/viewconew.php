...
window.onclick = function(e) {
  if (!e.target.matches('.dropbtn')) {
   ...
   <link rel="stylesheet" type="text/css" href="styleviewco.css">
  ...
  echo "<table><tr>";
   while($row=mysqli_fetch_row($result))
   {
	   ...
	   $v=$row[0];
	  // echo $row[0];
	   echo  "<img class='a' src='n.php?id=$v' alt='plant' onclick='openForm($v,$row[2])'  />";
	   echo	 " <center>";
...
function openForm(v,p) {
	...
	document.getElementById("ii").src="n1.php?id="+v;
	document.getElementById("gg").src="n2.php?id="+v;
	document.getElementById("ff").src="n3.php?id="+v;
	document.getElementById("zz").src="n4.php?id="+v;
