...
<body class="bgimage">
	...
	<marquee direction="right"><h1><u>Register for CO-CURRICULAR</u></h1></marquee>
	...
	<input type="file" placeholder="insert image" name="image3" required />
        ...
        $img5= addslashes(file_get_contents($image5));
			...
			$qq="INSERT INTO regisco (name,email,field,branch,image1,image2,image3,image4,image5) VALUES ('$n','$p','$q','$z','$img1','$img2','$img3','$img4','$img5');";
